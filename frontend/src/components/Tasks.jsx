                ...
                >
                  <div className="flex">
                    ...
                    <Tooltip text={'Edit this task'} position={'top'}>
                      <Link
                        to={`/tasks/${task._id}`}
                        className="ml-auto mr-3 text-green-600 cursor-pointer"
                      >
                    ...
                    <Tooltip text={'Mark as Complete'} position={'top'}>
                      {task.progress === 'Incomplete' ? (
                        ...
                        <span className="text-green-700 mr-3 cursor-pointer">
                  ...
                  <div className="whitespace-pre">Title: {task.title}</div>
